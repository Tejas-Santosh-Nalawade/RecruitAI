...
export default function CreateInterviewPage() {
  ...
  const getDefaultQuestions = (type: string) => {
    const questionSets = {
      ...
      'ai': [
        'This will be an AI-conducted interview with adaptive questions based on the candidate\'s responses.',
        'The AI will assess technical skills, communication, and cultural fit.',
            ...
            <div className="px-6 py-4">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">Schedule an interview with a candidate</p>
                </div>
              </div>
            </div>
          </header>
            ...
            <div className="max-w-4xl mx-auto space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div>
                      ...
                      <Badge className="capitalize">
                        {interviewData.interviewType.replace('-', ' ')}
                      </Badge>
                    </div>
                  </div>
                </CardContent>
              ...
              <Card className="shadow-lg border-0">
                <CardHeader>
                  ...
                  <CardDescription>
                    {interviewData.interviewType === 'ai' 
                      ? 'AI will use these guidelines to conduct the interview'
        ...
        <div className="min-h-screen bg-gray-50 flex items-center justify-center">
          <Card className="max-w-md w-full shadow-lg border-0">
            <CardContent className="p-8 text-center">
              ...
              <h1 className="text-2xl font-bold text-gray-900 mb-4">Interview Created!</h1>
